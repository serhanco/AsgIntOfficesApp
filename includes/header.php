    ...
    <header class="bg-acibadem-blue sticky top-0 z-50 shadow-md">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex space-x-2">
                    <a href="index.php" class="flex items-center px-4 py-2 rounded-full text-sm font-medium transition-colors <?= $currentPage === 'home' ? 'bg-white/10 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?>">
                        <i class="ph ph-target text-lg mr-2"></i>Nearest Office
                    </a>
                    <a href="map.php" class="flex items-center px-4 py-2 rounded-full text-sm font-medium transition-colors <?= $currentPage === 'map' ? 'bg-white/10 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?>">
                        <i class="ph ph-globe-hemisphere-west text-lg mr-2"></i>Global Map
                    </a>
                    <a href="offices.php" class="flex items-center px-4 py-2 rounded-full text-sm font-medium transition-colors <?= $currentPage === 'offices' ? 'bg-white/10 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?>">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-acibadem-blue border-t border-white/10">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <a href="index.php" class="flex items-center px-3 py-2 rounded-md text-base font-medium <?= $currentPage === 'home' ? 'bg-white/10 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?>">
                    <i class="ph ph-target text-xl mr-3"></i>Nearest Office
                </a>
                <a href="map.php" class="flex items-center px-3 py-2 rounded-md text-base font-medium <?= $currentPage === 'map' ? 'bg-white/10 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?>">
                    <i class="ph ph-globe-hemisphere-west text-xl mr-3"></i>Global Map
                </a>
                <a href="offices.php" class="flex items-center px-3 py-2 rounded-md text-base font-medium <?= $currentPage === 'offices' ? 'bg-white/10 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?>">
