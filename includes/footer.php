            ...
            <div class="flex flex-col md:flex-row justify-between items-center md:items-start space-y-8 md:space-y-0">
                ...
                <div class="flex flex-col items-center md:items-start">
                    ...
                    <ul class="space-y-2 text-center md:text-left">
                        ...
                        <li><a href="<?= getBaseUrl() ?>/api/offices" target="_blank" class="text-gray-400 hover:text-white transition-colors text-sm flex items-center gap-1"><i class="ph-fill ph-code"></i> API (JSON)</a></li>
                    </ul>
                </div>
